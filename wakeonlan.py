...
DEFAULT_PORT = 9
DEFAULT_INTERFACE = socket.gethostbyname(socket.gethostname())
...
def send_magic_packet(
    *macs: str, ip_address: str = BROADCAST_IP, port: int = DEFAULT_PORT, interface: str = DEFAULT_INTERFACE
) -> None:
    """
    ...
    Keyword Args:
        ...
        interface: the ip address of the NIC magic packet should be send through
...
def main(argv: List[str] = None) -> None:
    ...
    parser.add_argument(
        ...
        help="The nic ip adresse to send the magic packet to.",
    )
